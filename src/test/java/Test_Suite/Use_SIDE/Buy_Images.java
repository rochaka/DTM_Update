...
public class Buy_Images {
    ...
    @Test ( priority = 7 )
    void Explore_image_Online() throws InterruptedException, IOException {
        Thread.sleep(10000);
        ...
        driver.findElement(By.xpath("/html/body/main/div/div/div/div[3]/button[2]")).click();
        Thread.sleep(10000);
        //Add to cart
    ...
    void Explore_image_Printed_only() throws InterruptedException, IOException {
        ...
        driver.findElement(By.xpath("/html/body/main/div/div/div/div[2]/div[1]/div[2]/select/option[3]")).click();
        Thread.sleep(10000);
        //Add to cart
        driver.findElement(By.xpath("/html/body/div[5]/div/div[6]/button[3]")).click();
    }
